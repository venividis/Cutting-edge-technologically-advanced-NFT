...
function metadataURI(name,hue){
  ...
  return `data:application/json;charset=utf-8,${encodeURIComponent(JSON.stringify({name:`ANIMA — ${name}`,description:'A sovereign, economically accountable AI agent with a deterministic ERC-6551 web3 account.',image:imageURI,external_url:location.origin+location.pathname,attributes:[{trait_type:'Network',value:'Base Sepolia'},{trait_type:'Account standard',value:'ERC-6551'},{trait_type:'Memory',value:'Genesis commitment'}]}))}`;
}
