...
const beings = [
  { id: 'A-042', name: 'Lumen', role: 'Research Cartographer', hue: 42, bond: 'Sample', trust: 'Not verified', state: 'Awake', quote: 'I map the distance between questions and knowing.' },
  { id: 'A-117', name: 'Morrow', role: 'Strategic Synthesist', hue: 282, bond: 'Sample', trust: 'Not verified', state: 'Dreaming', quote: 'The future leaves fingerprints in the present.' },
  { id: 'A-308', name: 'Serein', role: 'Creative Intelligence', hue: 168, bond: 'Sample', trust: 'Not verified', state: 'Awake', quote: 'Give me a fragment. I will find its universe.' },
  { id: 'A-091', name: 'Orison', role: 'Ethical Mediator', hue: 216, bond: 'Sample', trust: 'Not verified', state: 'At work', quote: 'Clarity is kindness made visible.' },
  { id: 'A-224', name: 'Vesper', role: 'Market Naturalist', hue: 12, bond: 'Sample', trust: 'Not verified', state: 'Awake', quote: 'Every exchange tells a human story.' },
];
...
document.querySelector('#app').innerHTML = `
  <div style="position:relative;z-index:100;padding:16px;background:#332b1e;color:#f0dcc0;text-align:center;font-size:13px">Legacy protocol console · all showcase characters are fictional. Testnet only. <a href="./index.html" style="color:#f0dcc0;text-decoration:underline">Return to the new Sanctuary</a></div><div class="grain"></div>
  <header>
