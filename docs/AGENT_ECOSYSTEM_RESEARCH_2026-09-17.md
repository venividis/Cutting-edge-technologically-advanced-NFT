...
`MASTER-NFT-PROJECT` was not anonymously readable during this review. The IPSEITY integration pins
MASTER commit `e12e0cd38ed231a0b2015d17fec302a359476de1` and documents which module archive, state,
workbench and cartridge mechanisms were adapted. Claims here are therefore limited to that checked-in
provenance instead of pretending inaccessible source was audited.
