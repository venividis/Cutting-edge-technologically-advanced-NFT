...
> Status: reference implementation. 27 contracts, 279 tests in each implementation mode, 25 review findings fixed.
...
- **Unaudited.** 279 tests and an adversarial review pass are not an audit.
...
npx hardhat test       # 279 tests against the monolith
