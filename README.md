...
> Status: reference implementation. 26 contracts, 240 tests, 23 review findings fixed.
...
npx hardhat test       # 240 tests against the monolith
npm run test:diamond   # the same 240 against the EIP-2535 build
